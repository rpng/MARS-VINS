...
namespace MARS {
    ...
    GenericDriver::GenericDriver(char *imu_path, char *left_image_path, char *right_image_path) {
    ...
    void GenericDriver::startIMU() {
        imu_file_.open(imu_path_);
        std::cout << imu_path_ << std::endl;
    }
    ...
    bool GenericDriver::LoadPGMFile(struct Generic_Image *img, const std::string &file_name) {
        char junk[100];
